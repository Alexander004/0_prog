```{r}
library(readr)
All_data_cleared <- read_csv("~/0_HSE_study/колы/training_8/Data/All_data_cleared_2.csv")
All_data_cleared
```
```{r}
library(dplyr)
...
summary(model1)
```
For the Political Rights - Development Index model, the independent variable (Development Index) is significant at the 0.001 level (p-value: 9.803e-12). The coefficient estimate of Development Index is 10.822, indicating a positive relationship between Development Index and Political Rights. The model explains 64.69% of the variability in the dependent variable, and the F-statistic (9.803e-12 < 0,05) indicates that the model has predictive capability.
...
summary(model2)
```
For the Civil Liberties - Development Index model, the independent variable (Development Index) is significant at the 0.001 level (p-value: 3.438e-15). The coefficient estimate of Development Index is 15.251, indicating a positive relationship between Development Index and Civil Liberties. The model explains 75.13% of the variability in the dependent variable, and the F-statistic (3.438e-15 < 0,05) indicates that the model has predictive capability.
...
summary(model3)
```
For the Civil Liberties - Development Index model, the independent variable (Development Index) is significant at the 0.001 level (p-value: 6.73e-10). The coefficient estimate of Development Index is 30326, indicating a positive relationship between Development Index and Civil Liberties. The model explains 57,49% of the variability in the dependent variable, and the F-statistic (6.727e-10 < 0,05) indicates that the model has predictive capability.
...
summary(model4)
```
For the Population growth - Development Index model, the independent variable (Development Index) is significant at the 0.001 level (p-value: 2.021e-05). The coefficient estimate of Development Index is 0.5478, indicating a positive relationship between Development Index and Population growth. The model explains 33.51% of the variability in the dependent variable, and the F-statistic (2.021e-05 < 0,05) indicates that the model has predictive capability.
